...
exports.runHardhatTests = runHardhatTests;
...
async function runHardhatTests() {
    try {
        ...
        if (vscode.workspace.workspaceFolders && vscode.workspace.workspaceFolders.length > 0) {
            const hardhatFolder = vscode.workspace.workspaceFolders.find(folder => folder.uri.fsPath.includes('hardhat-project'));
        ...
        const { stdout, stderr } = await execPromise('npx hardhat test --network baseSepolia', {
            cwd: projectPath,
...
//# sourceMappingURL=hardhatRunner.js.map